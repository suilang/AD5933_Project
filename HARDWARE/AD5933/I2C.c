...
//#define AD5933_Correction 101615461.47044108
#define AD5933_Correction   10667571.4611
//#define AD5933_Correction   23903484

#define 


u8 AD5933_INIT_Model=0;
...
void AD5933_GET(void){
	...
	AD5933_Sweep(40000,2,10,AD5933_OUTPUT_2V,AD5933_Gain_1,AD5933_Fre_Rep);
	temdate=Get_resistance(10);
}
...
float DA5933_Get_Rs(void)
{
	...
	AD5933_Sweep(40000,200,1,AD5933_OUTPUT_2V,AD5933_Gain_1,AD5933_Fre_Rep);
